...
/**
 * The UI for picking the range of prices
 */
  ...
  render(): React.ReactNode {
    ...
    return (
      <div
        style={{
          paddingLeft: '5%',
          paddingRight: `calc(5% + ${AmountSlider.getYAxisWidth()}px)`,
          height: '65vh',
          margin: "auto",
        }}
        ...
        {(this.props.hidden || false) ? null : (
          <ResponsiveContainer height="90%" width="100%">
            <BarChart data={data} barCategoryGap={0} margin={{bottom: 0, left: 0, right: 0}}>
              ...
              <YAxis
                domain={[0, 'dataMax']}
                tickFormatter={(v) => Math.round(v / this.props.dataloader.getTotal() * 100) + '%'}
